...
$('document').ready(function () {
    ...
    $("#input-btn").on("click", function () {
        ...
        if (password === 'Raver Forever') {
            window.open('hidden.html', '_parent');
        } else {
    ...
    var countDownDate = new Date("Nov 1, 2024 20:00:00").getTime();
    ...
    var x = setInterval(function () {
        ...
        if (distance < 0) {
            clearInterval(x);
            document.getElementById("demo").innerHTML = "THE PIT IS OPEN!! COME JOIN US!";
        }
    }, 1000);
})
